...
const results = [
    {
        ...
        period: "8 months",
        highlight: "9x revenue growth",
        growth: 90,
    },
    {
        brand: "CloudNine Scents",
        category: "Home Fragrance",
        before: "$0",
        after: "$50K/mo",
        metric: "Monthly Revenue",
        period: "5 months",
        highlight: "0 → $50K from scratch",
        growth: 100,
    },
    {
        brand: "TrekForce Outdoors",
        category: "Sports & Outdoor",
        before: "US only",
        after: "US + UK + CA",
        metric: "Marketplace Reach",
        period: "6 months",
        highlight: "Revenue 3x across 3 markets",
        growth: 75,
    },
    {
        brand: "GardenMate",
    ...
    },
    {
        ...
        before: "38% ACOS",
        after: "14% ACOS",
        metric: "Advertising Cost of Sale",
        period: "3 months",
        highlight: "$20K/month in ad savings",
        growth: 63,
    },
];
    ...
    return (
        <section className="py-24 md:py-32 bg-[#FAF3E1] relative overflow-hidden border-t border-[#E8D5A8]">
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                ...
                >
                    <p className="text-[#6B5C3E] text-sm mb-4">Join 10+ brands that have transformed their Amazon business</p>
                    <a
                        href="/testimonials"
